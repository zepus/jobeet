...
$browser->info('  3.4 - On the preview page, you can delete the job')->
        ...
        with('doctrine')->begin()->
            check('JobeetJob', array('position' => 'FOO2'), false)->
        end()
        ;
...
$browser->info('  3.6 - A job validity cannot be executed before the job expires soon')->
...
// Built-in Security Feautures - Job submission with a token field
$browser->
        get('/job/new')->
        click('Preview your job', array('job' => array(
            'token' => 'fake_token',
